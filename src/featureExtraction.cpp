...
public:
    ...
    void publishFeatureCloud()
    {
        ...
        // {
        //     if( isnan(extractedCloud->points[i].x) || isnan(extractedCloud->points[i].y) || isnan(extractedCloud->points[i].z) )
        //     {
        //         std::cout << "x: " << extractedCloud->points[i].x << std::endl;
        //         std::cout << "y: " << extractedCloud->points[i].y << std::endl;
        //         std::cout << "z: " << extractedCloud->points[i].z << std::endl;
        //         std::cout << "--------------" << std::endl;
        //     }
        // }
